    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ingredient_in', to='recipes.ingredients', to_field='name')),
            ],
        ),
        migrations.CreateModel(
            name='Recipes',
            fields=[
                ...
                ('ingredients', models.ManyToManyField(related_name='recipes_ingredients', through='recipes.IngredientsInRecipes', to='recipes.ingredients', verbose_name='Ингридиент')),
            ],
            options={
                'verbose_name': 'Рецепт',
        ...
        migrations.AddField(
            model_name='recipes',
            name='tags',
            field=models.ManyToManyField(related_name='recipes_tags', through='recipes.TagsInRecipes', to='recipes.tags', verbose_name='Тег'),
        ),
        migrations.AddField(
            model_name='ingredientsinrecipes',
            name='recipe',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipe_in', to='recipes.recipes'),
        ),
        migrations.CreateModel(
            name='Follow',
            fields=[
